...
export function AxlApp({ preview }: { readonly preview?: WebPreview } = {}): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setError(cause instanceof Error ? cause.message : "Could not save the theme preference");
    }
